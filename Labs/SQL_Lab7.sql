--Name: Ricardo D AldanaSalas
--File: lab-chapter07.sql
...
select custid, orderid, qty,
	...
	lead(qty) over(partition by custid order by orderdate, orderid) - qty as Y
from dbo.orders;
...
-- 4 Write a query against the dbo.Orders table that returns a row for each employee, a column for each order year, and the count of orders
